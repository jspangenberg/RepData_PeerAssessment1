...
```
- The mean total number of steps taken per day: `r meanTotalNrOfStepsPerDay`
- The median total number of steps taken per day: `r medianTotalNrOfStepsPerDay`
...
```
The `r maxInterval`th interval is the interval with the maximum number of steps.
...
```
Total number of rows with NAs: `r totNrWithNAs`
...
```
- Mean total number of steps taken per day: `r meanTotalNrOfStepsPerDayComplete`
- Median total number of steps taken per day: `r medianTotalNrOfStepsPerDayComplete`
